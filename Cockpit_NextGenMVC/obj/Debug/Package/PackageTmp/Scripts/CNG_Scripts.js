...
$(document).ready(function () {
    ...
    if (!ChangeFollowupOwnershipWindow.data("kendoWindow")) {
        ChangeFollowupOwnershipWindow.kendoWindow({
            width: "700px",
            actions: ["Close"],
            title: "Change Followup Ownership",
            close: function () {
                // alert("Closed filters.");
            }
        });
...
// Generic Tabs responsive script
