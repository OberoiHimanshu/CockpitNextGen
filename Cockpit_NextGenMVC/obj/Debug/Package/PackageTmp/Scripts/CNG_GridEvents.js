...
function AddIndiactor_SNI_ReleaseDate() {
    ...
    $.each(data, function (i, row) {
        ...
        if (DBAGINGBUCKET == "Overdue" || DBAGINGBUCKET == "Late") {
            ...
            $('tr[data-uid="' + row.uid + '"] td:nth-child(20)').append('<img class="Banti" name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletred + '"/>');

        }
        if (DBAGINGBUCKET == "InProcess") {

            $('tr[data-uid="' + row.uid + '"] td:nth-child(20)').append('<img name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletYellow + '"/>');
        }
        if (ReleaseDate != '1970-01-01') {
            if (CurrentDate > ReleaseDate) {
                $('tr[data-uid="' + row.uid + '"] td:nth-child(21)').append('<img class="Banti" name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletred + '"/>');
            }

            if (ReleaseDate >= pastWeekDate || ReleaseDate == CurrentDate) {
                $('tr[data-uid="' + row.uid + '"] td:nth-child(21)').append('<img name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletYellow + '"/>');
            }
        }
...
function AddIndiactor_Aging() {
    ...
    $.each(data, function (i, row) {
        ...
        if (ReleaseDate != '1970-01-01') {
            if (CurrentDate > ReleaseDate) {
                $('tr[data-uid="' + row.uid + '"] td:nth-child(22)').append('<img class="Banti" name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletred + '"/>');
            }

            if (ReleaseDate >= pastWeekDate || ReleaseDate == CurrentDate) {
                $('tr[data-uid="' + row.uid + '"] td:nth-child(22)').append('<img name="imgIndiacot" style="float:right !important; height:20px !important;" src="' + bulletYellow + '"/>');
            }
        }
