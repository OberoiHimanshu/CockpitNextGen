...
namespace Cockpit_NextGenMVC.Controllers
{
        ...
        public ActionResult DB_WaterFall()
        {
            ...
            if (!ViewData.Keys.Contains("lst_GraphData_Raw"))
            {
                if (oSessionUser.ROLE_DESC == "BPA" || oSessionUser.ROLE_DESC == "Regional Lead")
                {
                    ...
                    foreach (Tbl_SNI_Release_Projection objProjection in lst_GraphData_Raw)
                    {
                        if (objProjection.Feedback.Value.Year < 2000)
                        {
                            objProjection.Feedback_Calc_Est_Invoice_dt_Month = "TBC";
                        }
                        else if (objProjection.Feedback_Calc_Est_Invoice_dt_Month != "TBC")
                        {
                            objProjection.Feedback_Calc_Est_Invoice_dt_Month += " - " + objProjection.Feedback.Value.Year.ToString();
                        }
                    }
                ...
                else
                {
                    ...
                    foreach (Tbl_SNI_Release_Projection objProjection in lst_GraphData_Raw)
                    {
                        ...
                        else if (objProjection.Feedback_Calc_Est_Invoice_dt_Month != "TBC" && !objProjection.Feedback_Calc_Est_Invoice_dt_Month.Contains(objProjection.Feedback.Value.Year.ToString()))
                        {
                            objProjection.Feedback_Calc_Est_Invoice_dt_Month += " - " + objProjection.Feedback.Value.Year.ToString();
                        }
                    }
    ...
    public class Model_WaterFall
    {
        public string Backlog_Status { get; set; }
        public double Interval { get; set; }
        public double Interval_Diff { get; set; }
    }

    public class Model_Pie
    {
    ...
    public class Model_Bars
    {
        public string category { get; set; }
        public double[] value { get; set; }
        public string[] othervalue { get; set; }

        public List<Backlogstats> RawData;
    }

    public class Release_Summary
    {
