...
namespace B_Web_App.Controllers
{
    public class BCRController : Controller
    {
        ...
        public List<VW_BCR_SignOff_Summary> Closed_BCRSummary, Closed_BCRSummary_Result;
        public List<Tbl_Daily_Control_Reports_Summary> BCRSummary;
        ...
        public ActionResult Summary()
        {
            ...
            if (oDashboardModal.UI_Type == "CSR Cockpit")
            {
                ...
                BCRSummary = service.Database.SqlQuery<Tbl_Daily_Control_Reports_Summary>("usp_BCR_GetSummary '" + oSessionUser.SAP_User_Name + "','" + oSessionUser.SUPERREGION + "','" + oSessionUser.ROLE_DESC + "','" + oSessionUser.TEAM_NAME + "','").ToList();
            }
            else
            {
                ...
                BCRSummary = service.Database.SqlQuery<Tbl_Daily_Control_Reports_Summary>("usp_BCR_GetSummary '" + oSessionUser.FULLNAME + "','" + oSessionUser.SUPERREGION + "','" + oSessionUser.ROLE_DESC + "','" + oSessionUser.TEAM_NAME + "','").ToList();
            }
        ...
        public ActionResult Closed_Summary()
        {
            ...
            if (oSessionUser.ROLE_DESC == "WW Lead")
                Closed_BCRSummary = service.Database.SqlQuery<VW_BCR_SignOff_Summary>("Exec usp_Get_closed_BCR_Summary '','" + DtFrom + "','" + DtTo + "'").ToList();
            else
                Closed_BCRSummary = service.Database.SqlQuery<VW_BCR_SignOff_Summary>("Exec usp_Get_closed_BCR_Summary '" + oSessionUser.SUPERREGION + "','" + DtFrom + "','" + DtTo + "'").ToList();
