...
namespace B_Web_App.Models
{
    public class DashboardModal
    {
        ...
        public List<Tbl_Followup_Summary> FollowupSummary { get; set; }
        public List<Tbl_Followups> SystemGeneratedFollowups { get; set; }
        ...
        public List<Tbl_Daily_Control_Reports_Summary> My_BCRSummary;

        public DashboardModal BuildControlReportsSummaryforUI(DashboardModal oDashboardModal, List<Tbl_Daily_Control_Reports_Summary> BCRSummary, VW_USERS oSessionUser)
        {
    ...
    public class Session_Filters
    {
        ...
        public Session_Filters Set_ServiceFilters()
        {
            Session_Filters oResult = new Session_Filters();
